    ...
    <footer className="p-8 bg-background/80 backdrop-blur-xl border-t border-white/5 z-30">
      <div className="max-w-4xl mx-auto relative group">
        <textarea
          ...
          className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 pr-16 focus:outline-none focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all text-slate-100 placeholder-slate-500 resize-none shadow-2xl"
